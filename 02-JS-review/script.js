...
// Adding a new property and spread operators with objects
...
//Template Literals
const summary = `${title}, is a ${pages}-page long book, was written by ${author} and published in ${getYear(publicationDate)}. The book has ${hasMovieAdaptation ? "" : "not"} been adapted as a movie} `;
summary;

//Tenary Operator
const pageRange = pages > 1000 ? "Over a thousand" : "Less than a thousand";
pageRange;
console.log(`The book has ${pageRange} page`)
